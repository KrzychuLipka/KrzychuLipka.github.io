...
}`)}},35925:(e,t,r)=>{r.d(t,{Xq:()=>s,wk:()=>a});const i={dash:[4,3],dot:[1,3],"long-dash":[8,3],"short-dash":[4,1],"short-dot":[1,1]},o={dash:i.dash,"dash-dot":[...i.dash,...i.dot],dot:i.dot,"long-dash":i["long-dash"],"long-dash-dot":[...i["long-dash"],...i.dot],"long-dash-dot-dot":[...i["long-dash"],...i.dot,...i.dot],none:null,"short-dash":i["short-dash"],"short-dash-dot":[...i["short-dash"],...i["short-dot"]],"short-dash-dot-dot":[...i["short-dash"],...i["short-dot"],...i["short-dot"]],"short-dot":i["short-dot"],solid:null},n=8;function a(e){return{pattern:[e,e],pixelRatio:2}}function s(e){return"style"===e?.type?function(e){return null!=e?function(e,t){return null==e?e:{pattern:e.slice(),pixelRatio:t}}(o[e],n):null}(e.style):null}},37923:(e,t,r)=>{r.d(t,{C:()=>m,b:()=>v});var i=r(26917),o=r(59395),n=r(90080),a=r(54478),s=r(94192),l=r(66763),c=r(80883),h=r(3799),d=r(58350),u=r(86955),g=r(66470),p=r(91911),f=r(2687);function v(e){const t=new f.N5,{vertex:r,fragment:v,attributes:m,varyings:_}=t,{vvColor:y,hasVertexColors:x}=e;return(0,h.NB)(r,e),t.include(o.d,e),t.include(a.c,e),t.include(l.A,e),t.include(n.g,e),v.include(i.HQ,e),t.include(p.z,e),t.include(s.Z,e),m.add(g.r.POSITION,"vec3"),y&&m.add(g.r.COLORFEATUREATTRIBUTE,"float"),x||_.add("vColor","vec4"),_.add("vpos","vec3"),r.uniforms.add(new d.E("uColor",(e=>e.color))),r.main.add(u.H`
      vpos = position;
